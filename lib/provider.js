...
function provideUpdatedSince (when, cb) {
  provide(
      function (post) { 
        log.info('provider', 'when', when);
        log.info('provider', 'when type', typeof when);
        log.info('provider', 'updated', post.metadata.updated);
        log.info('provider', 'updated type', typeof post.metadata.updated);
