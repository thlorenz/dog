...
function scaffold(tgt, scaffolded) {
  ...
  function printHelpMessage(cb) {
    ...
    log.info('scaffolder', 'You can preview it by typing:   dog preview intro-to-dog');
    log.info('scaffolder', 'You can publish it by typing:   dog publish intro-to-dog -t "Dog Introduction" -g "dog cli nodejs"');
    log.info('scaffolder', 'You can unpublish it by typing: dog unpublish intro-to-dog');
